...
public class RtmpHandShake {
    ...
    private byte[] getHandshake(byte[] b) {
        long schema = (((b[4] & 0xFF) << 24) | ((b[5] & 0xFF) << 16)
                | ((b[6] & 0xFF) << 8) | (b[7] & 0xFF)) & 0xFFFFFFFFL;
        // Flash Player 10.0.32.18
        int offset = schema < 0x80000302L ? GetClientGenuineConstDigestOffset(b)
                : GetServerGenuineConstDigestOffset(b);
