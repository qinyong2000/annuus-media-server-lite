...
public class VideoTag extends MediaSample {
    ...
    public VideoTag(long timestamp, DataBuffer data) {
        super(MediaSample.MEDIA_VIDEO, timestamp, data);
    }

    public VideoTag(long timestamp, boolean keyframe, long offset, int size) {
        super(MediaSample.MEDIA_VIDEO, timestamp, keyframe, offset, size);
    }
